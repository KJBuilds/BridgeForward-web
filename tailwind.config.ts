  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "bf-black": "hsl(var(--bf-black))",
        "bf-charcoal": "hsl(var(--bf-charcoal))",
        "bf-blue": "hsl(var(--bf-blue))",
        "bf-purple": "hsl(var(--bf-purple))",
        "bf-magenta": "hsl(var(--bf-magenta))",
        "bf-orange": "hsl(var(--bf-orange))",
        "bf-silver": "hsl(var(--bf-silver))",
        sidebar: {
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { opacity: "0.4" }, "50%": { opacity: "0.85" } },
